        ...
        <div className="flex flex-col lg:flex-row justify-evenly gap-4">
          {currentUser && currentUser !== null ? (
            <>
              ...
              {open && (
                <div>
                  <ul
                    ...
                    className="absolute z-10 min-w-[180px] w-full overflow-auto rounded-md border border-blue-gray-50 bg-white p-3 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none"
                  >
                    ...
                    >
                      <button
                        ...
                        className="flex items-center   rounded-lg  group w-full "
                        >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                        ...
                        <span className="ms-3  lg:hidden group-hover:text-gray-900 group-hover:scale-105">
                          Tender
                        </span>
                      </button>
                    </li>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className=" ms-3  lg:hidden group-hover:text-gray-900 group-hover:scale-105 whitespace-nowrap">
                          All Tender
                        </span>
                      </button>
                    </li>
              ...
              <div className="sm:ml-32 lg:ml-64 w-full max-w-8xl overflow-x-auto custom-scrollbar ">
